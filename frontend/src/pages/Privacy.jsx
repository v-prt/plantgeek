      ...
      <FadeIn>
        <section className='document'>
          ...
          <p>
            ...
            document contains types of information that is collected and recorded by plantgeek and
            how we use it.
          </p>
          <p>
          ...
          <p>
            ...
            plantgeek. This policy is not applicable to any information collected offline or via
          ...
          <h2>Log Files</h2>
          <p>
            plantgeek follows a standard procedure of using log files. These files log visitors when
          ...
          <p>
            ...
            plantgeek, which are sent directly to users' browser. They automatically receive your IP
          ...
          <p>
            Note that plantgeek has no access to or control over these cookies that are used by
            third-party advertisers.
          </p>
          <h2>Third Party Privacy Policies</h2>
          <p>
            plantgeek's Privacy Policy does not apply to other advertisers or websites. Thus, we are
          ...
          <p>
            plantgeek does not knowingly collect any Personal Identifiable Information from children
