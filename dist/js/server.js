...
// HANDLERS
const { createUser, resendVerificationEmail, authenticateUser, verifyToken, verifyEmail, sendPasswordResetCode, resetPassword, getUsers, getUser, getWishlist, getCollection, updateUser, updateLists, deleteUser, } = require('./handlers/userHandlers.js');
const { createPlant, getPlants, getPlantsToReview, getPlant, getSimilarPlants, getRandomPlants, getUserPlants, getUserContributions, addComment, updatePlant, deletePlant, } = require('./handlers/plantHandlers.js');
const { createSuggestion, getSuggestions, getSuggestionsBySlug, updateSuggestion, } = require('./handlers/suggestionHandlers.js');
